...
public class CobrarCuota {
  ...
  public void generarPdf(String dni, String nombres, String apellido) {
    ...
    try {
        ...
        Font comprobanteFuente = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 16, BaseColor.BLACK);
        Paragraph comprobante = new Paragraph("Comprobante de pago.", comprobanteFuente);
        PdfPCell comprobanteCell = new PdfPCell(comprobante);
        comprobanteCell.setBorder(Rectangle.NO_BORDER);
        comprobanteCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
        comprobanteCell.setVerticalAlignment(Element.ALIGN_MIDDLE);
